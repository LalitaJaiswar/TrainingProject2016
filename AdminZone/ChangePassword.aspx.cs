...
public partial class AdminZone_ChangePassword : System.Web.UI.Page
{
    ...
    protected void BtnSubmit_Click(object sender, EventArgs e)
    {
        ...
        string Query="update Login set passwd='"+newpassword+"' where userid='"+Session["adminid"]+"' and passwd='"+oldpassword+"'";
        ...
        {
            Response.Write("<script>alert('Passowrd is not changed.')</script>");
        }
    }
}